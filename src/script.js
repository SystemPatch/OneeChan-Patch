    ...
    $SS = {
        ...
        options: {
            ...
            init: function() {
                ...
                const a = $("<span id='oc-shortcut-settings' class='shortcut brackets-wrap'><a id='OneeChanLink' title='OneeChan Settings' class='fa fa-gears' href='javascript:;'>OneeChan</a></span>").bind("click", $SS.options.show);
                /* When no icons */
                const b = $("<span id='OneeChanLink'> [<a title='OneeChan Settings' href='javascript:;'>OneeChan</a>]&nbsp;</span>").bind("click", $SS.options.show);
                /* When 4chan XT */
                const c = $("<span id='oc-shortcut-settings' class='shortcut brackets-wrap' data-index='825'><a class='settings-link' id='OneeChanLink' title='OneeChan Settings' href='javascript:;'><span class='icon--alt-text'>OneeChan Settings</span>" + $SS.theme.icons.gearsIcon + "</a></span>").bind("click", $SS.options.show);
            ...
            createMascotsTab: function(tOptions) {
                ...
                p.append($("<a class='options-button' href='https://bluearchive.wiki/wiki/Category:Character_sprites' title='Get more mascots. Possibly NSFW.' target='_blank'>More Mascots"));
